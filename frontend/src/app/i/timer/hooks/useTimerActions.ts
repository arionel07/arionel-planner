...
type TypeUserTimerAction = ITimerState & {
	rounds: IPomodoroRoundsResponse[] | undefined
}

export function useTimerActions({activeRound, setIsRunning, secondsLeft, rounds, setActiveRound}: TypeUserTimerAction) {
	...
	return {IsUpdateRoundPending, pauseHandler, prevRoundHandler, nextRoundHandler, playHandler}
}